...
public class UsuarioRestController {
	...
	public ResponseEntity<?> update(@RequestBody UsuarioDTO usuario) {
	    ...
	    try {
	    	if (usuario.getUsername() != null && !usuario.getUsername().isEmpty() && usuarioService.findByUsername(usuario.getUsername()) == null) {
	            usuarioActual.setUsername(usuario.getUsername());
	        }
	        
	        if (usuario.getEmail() != null && !usuario.getEmail().isEmpty() && usuarioService.findByMail(usuario.getEmail()) == null) {
